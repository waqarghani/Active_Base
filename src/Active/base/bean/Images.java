...
public class Images implements Comparable<Images>{
	...
	public Images(String Path, String ImageType, boolean IsValid, List<Integer> Dimensions) {
		super();
	...
	public String toString() {
		return  "ImageId~" + ImageId + "# Dimensions~" + Dimensions + "# Path~" + Path + "# ImageType~"+ ImageType + 
				"# IsValid~" + IsValid + "#" + Rois ;
	}
